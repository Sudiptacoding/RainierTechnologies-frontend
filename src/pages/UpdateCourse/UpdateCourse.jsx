...
const UpdateCourse = () => {
    ...
    useEffect(() => {
        axiosData.get(`/api/update/${id}`)
            .then(res => {
                setData(res.data)
                setTopic(res.data?.topic)
                setDays(res.data?.schedule?.classDays)
            })
    }, [id])
    ...
    const handelSubmit = (e) => {
        ...
        console.log(data)
        axiosData.put(`/api/update/${id}`, data)
            .then(res => {
                Swal.fire({
                    title: "Good job!",
                    text: "You course Updated successfully!",
                    icon: "success"
                });
            })
    }
                    ...
                    <form onSubmit={handelSubmit}>
                        <div className="grid sm:grid-cols-12 gap-2 sm:gap-6">
                            ...
                            <div className="sm:col-span-9">
                                <input required name='name' defaultValue={data?.name} type="text" className="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="course name" />
                            </div>
                            <div className="sm:col-span-3">
                                <label className="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                                    Price
                            ...
                            <div className="sm:col-span-9">
                                <input required name='price' defaultValue={data?.price} type="number" className="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="course price" />
                            </div>
                            <div className="sm:col-span-3">
                                <label className="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                                    Duration
                            ...
                            <div className="sm:col-span-9">
                                <input required name='week' type="number" defaultValue={data?.week} className="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="-weeks" />
                            </div>
                            <div className="sm:col-span-3">
                                <label className="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                                    Schedule
                            ...
                            <div className="sm:col-span-9">
                                ...
                                <div className="sm:flex">
                                    <input defaultValue={data?.schedule?.classTime}
                                        type="text"
                                    ...
                                    <input defaultValue={data?.schedule?.classTimeEnd}
                                        type="text"
                                        onFocus={(e) => (e.target.type = "time")}
                                        onBlur={(e) => (e.target.type = "text")}
                                        name='endTime'
                            ...
                            <div className="sm:col-span-9">
                                <div className="sm:flex items-center gap-2 flex-wrap">
                                    {
                                        data?.schedule?.classDays?.map((item, i) => {
                                            return <button key={i} className='border bg-gray-100 font-semibold px-3 py-1 rounded-full'>{item}</button>
                                        })
                                    }
                                </div>
                            </div>
                            ...
                            <div className="sm:col-span-9">
                                <div className="sm:flex">
                                    <select defaultValue={data?.level} name='label' className="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm -mt-px -ms-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-s-lg sm:mt-0 sm:first:ms-0 sm:first:rounded-se-none sm:last:rounded-es-none sm:last:rounded-e-lg text-sm relative focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                                        <option value={data?.level} selected disabled hidden>{data?.level}</option>
                            ...
                            <div className="sm:col-span-3">
                                <label className="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200"> Topics
                                </label>
                            </div>
                            <div className="sm:col-span-9">
                                <div className="sm:flex items-center gap-2 flex-wrap">
